...
% end
% 读取每个文件夹下的数据文件
path= '/Users/lu_yk/Desktop/Data/SMLM/20250627_Rh-2-OMe/';
SMbrightness(path);
% Data2Video(path);
% SMdatafit(path);
toc
...
for x=1:datanumber
    ...
    count=1;
    for m=20:70%startframe:min(startframe+50,framesize)
        % 显示现在正在处理的数据
...
%             plot(fitResult,[xData,yData],zData)
        ...
        % Excel_save(Integral,data_save_name);
    ...
    % 
    %     %载入数据
    %     data = seq.imageData(:,:,startframe:end);
